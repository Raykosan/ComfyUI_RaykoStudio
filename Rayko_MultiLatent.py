...
class RS_multilatent:
    ...
    def generate(self, vae, size_mode, preset, width, height, megapixels, aspect_ratio, batch_size):
        latent_channels = 4
        scale_factor = 8
...
NODE_CLASS_MAPPINGS = {
    "RS_multilatent": RS_multilatent
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "RS_multilatent": "🦊 RS MultiLatent"
}